...
fig.savefig('gam-simple-boxplot.png')
...
fig.savefig('gam-grouped-boxplot.png')
...
ax.legend_.remove()
fig.savefig('gam-by-cell-boxplot.png')
...
fig.savefig('gam-mean-branch-distance-by-cell.png', dpi=300)
...
fig.tight_layout()
fig.savefig('gam branch distance by infection status.png', dpi=300)
